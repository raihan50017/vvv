...
if (isset($_POST['val_id'])) {
    ...
    if ($code == 200 && !(curl_errno($handle))) {
        ...
        $sql = "INSERT INTO loan_pay(amount, email, loan_id) VALUES('$amount', '$email', '$loan_id')";
        mysqli_query($conn, $sql);
        $update_loan_sql = "UPDATE loans SET status = 'paid' WHERE id = $loan_id";
        mysqli_query($conn, $update_loan_sql);
